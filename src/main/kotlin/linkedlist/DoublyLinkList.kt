...
/**
 * A doubly list implementation for the [LinkedList] interface
 */
class DoublyLinkList<T> : LinkedList<T> {
    ...
    override fun toString(): String {
        return buildString {
            append("[")
            for ((index, value) in this@DoublyLinkList.withIndex()) {
                append(value)
